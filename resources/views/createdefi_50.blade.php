...
//$(".writeinfo").append(data.msg); 
       ...
       //headerCell.innerHTML = "srno";
        ...
        headerCell.innerHTML = "header_url";
        row.appendChild(headerCell);
 
 
        headerCell = document.createElement("TH");
        headerCell.innerHTML = "website";
        row.appendChild(headerCell);

        
        headerCell = document.createElement("TH");
        headerCell.innerHTML = "twitter";
        row.appendChild(headerCell);

    
        headerCell = document.createElement("TH");
        headerCell.innerHTML = "followers";
        row.appendChild(headerCell);
       ...
       // console.log(excelRows);
        ...
        for (var i = 0; i < excelRows.length; i++) {
            ...
            cell.innerHTML = excelRows[i].head_url;
 
            cell = row.insertCell(-1);
            cell.innerHTML = excelRows[i].website;

            cell = row.insertCell(-1);
            cell.innerHTML = excelRows[i].twitter;

            cell = row.insertCell(-1);
            cell.innerHTML = excelRows[i].followers;
