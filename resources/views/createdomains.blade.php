...
//$(".writeinfo").append(data.msg); 
       ...
       //headerCell.innerHTML = "srno";
        ...
        headerCell = document.createElement("TH");
        headerCell.innerHTML = "actual cost";
        row.appendChild(headerCell);

        
        headerCell = document.createElement("TH");
        headerCell.innerHTML = "sale cost";
        row.appendChild(headerCell);
       ...
       // console.log(excelRows);
        ...
        for (var i = 0; i < excelRows.length; i++) {
            ...
            cell.innerHTML = excelRows[i].domain;
 
            cell = row.insertCell(-1);
            cell.innerHTML = excelRows[i].url;
 
            cell = row.insertCell(-1);
            cell.innerHTML = excelRows[i].actual_cost;

            cell = row.insertCell(-1);
            cell.innerHTML = excelRows[i].sell_cost;

            cell = row.insertCell(-1);
            cell.innerHTML = excelRows[i].tags;
